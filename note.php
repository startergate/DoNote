    ...
    <div class="col-md-3">
        <?php
          while ($row = mysqli_fetch_assoc($result)) {
            echo '<li><a href="./index.php?id='.$row['id'].'">'.$row["name"],'</li></a>'."\n";
            echo '<br />';
          }
        ?>
    ...
    <div class="col-md-9">
      <form action="process.php" method="post">
        <div class="form-group">
          ...
          ?>
          <?php
            echo "<textarea type='text' class='form-control' name='title' id='form-title' placeholder='제목을 작성하세요.'>".$name."</textarea>";
          ?>
        </div>
        <div class="form-group">
          <?php
            echo "<textarea class='form-control' name='description' id='form-title' placeholder='내용을 작성하세요.'>".$text."</textarea>";
          ?>
        </div>
        <input type="submit" name="name" value="수정한 내용을 저장!" class="btn btn-default btn-lg">
      </form>
    </div>
    </div>
    <script src="/bootstrap/js/bootstrap.min.js"></script>
